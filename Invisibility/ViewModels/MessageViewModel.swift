...
final class MessageViewModel: ObservableObject {
    ...
    public func updateMessagesForChat(_ chat: APIChat) {
        let initialBranch = BranchManagerModel.shared.initializeChatBranch(rootChat: chat)
        ...
        do {
            ...
            DispatchQueue.main.async { [weak self] in
                   ...
                   let lastRootChat = BranchManagerModel.shared.getRootChat(currentChat: lastChat, msgs: fetched_msgs, chats: fetched_chats)
                {
                    ...
                    self.updateMessagesForChat(lastRootChat)
                } else {
    ...
    public func addMessages(messages: [APIMessage]) {
        api_messages.append(contentsOf: messages)
    }
